    ...
    <div className={styles.container}>
      <div className={styles.center}>
        <h1 className="is-size-1">
          <strong className={classNames('has-margin-right-2', styles.colorImprove)}>{title}</strong>
          {subtitle}
        </h1>
        <span className="is-size-5">{detail}</span>
        <div className={classNames(styles.row, 'has-margin-bottom-2', 'has-margin-top-4')}>
          <SocialIcon link="https://facebook.com/kamontatc">
          ...
          <SocialIcon link="https://github.com/kamontat">
            <FontAwesomeIcon
              className={styles.colorImprove}
              icon={faGithub}
              size="2x"
              mask={['far', 'circle']}
              fixedWidth
